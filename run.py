...
class TrainLoop_fusion_rec():
    def __init__(self, opt, is_finetune):
        ...
        self.metrics_gen = {"dist1": 0, "dist2": 0, "dist3": 0, "dist4": 0,
                            "bleu1": 0, "bleu2": 0, "bleu3": 0, "bleu4": 0, "count": 0}
    ...
    def val(self, is_test=False):
        self.metrics_gen = {"ppl": 0, "dist1": 0, "dist2": 0, "dist3": 0,
                            "dist4": 0, "bleu1": 0, "bleu2": 0, "bleu3": 0, "bleu4": 0, "count": 0}
        self.metrics_rec = {"recall@1": 0, "recall@10": 0, "recall@50": 0,
        ...
        def distinct_metrics(outs):
            ...
            for sen in outs:
                ...
                for start in range(len(sen)-3):
                    quag = str(sen[start]) + ' ' + str(sen[start + 1]) + ' ' + \
